# ADR-069: morphedByMany — inverse polymorphic many-to-many
...
## ADR-069-01: `MorphedByMany` descriptor + accessor
...
## ADR-069-03: Query + eager integration (`mbm` kind)
