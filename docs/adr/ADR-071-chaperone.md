# ADR-071: chaperone (inverse parent hydration)
...
## ADR-071-01: `chaperone()` is a marker inside a `with_()` closure
...
## ADR-071-02: Inverse resolution — back_populates, then many-to-one inference
...
## ADR-071-03: Hydration via `set_committed_value`
