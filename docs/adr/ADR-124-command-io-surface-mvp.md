# ADR-124 — `Command` / `Context` I/O surface: ship the minimum-viable subset, defer prompts and tables

**Status**: Accepted
**Date**: 2026-05-19
**Supersedes**: none
**Superseded by**: none
**Related**: ADR-123 (CLI framework bootstrap), PRD-021 FR-021-23, FR-021-24
