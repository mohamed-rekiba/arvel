# ADR-152: relation-querying completeness
...
## ADR-152-01: `_has_predicate` — one recursive builder
...
## ADR-152-02: operator/count on `where_has`
...
## ADR-152-04: constrained `doesnt_have`
