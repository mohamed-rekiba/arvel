...
## ADR-143-01: `has_attached(relation, factory, *, count, pivot)`
...
## ADR-143-03: Faker passed to callbacks
...
## ADR-143-05: `connection(name)` per-factory routing
