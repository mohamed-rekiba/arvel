# ADR-128: Cast-aware Dirty Tracking
...
## ADR-128-01: Compare original vs current at the *cast* level
...
## ADR-128-02: `get_original` casts, `get_raw_original` doesn't
...
## ADR-128-03: Guard the `NO_VALUE` sentinel
