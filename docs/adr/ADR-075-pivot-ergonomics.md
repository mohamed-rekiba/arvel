# ADR-075: pivot ergonomics for BelongsToMany
...
## ADR-075-01: `PivotConfig` + fluent configuration
...
## ADR-075-02: `with_pivot` hydration
...
## ADR-075-04: pivot filters and ordering
...
## ADR-075-05: `create` / `save` on the relation
...
## ADR-075-06: deferred — custom `Pivot` model via `using`
