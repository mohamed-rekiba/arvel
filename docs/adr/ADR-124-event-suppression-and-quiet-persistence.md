# ADR-124: Re-entrant Event Suppression and Quiet Persistence
...
## ADR-124-01: Suppress events with a `ContextVar`, not a per-model flag
...
## ADR-124-02: `*_quietly` helpers wrap the existing methods in the context
