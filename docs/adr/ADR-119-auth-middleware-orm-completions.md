# ADR-119: Auth Middleware and ORM Correctness Fixes
...
## ADR-044-001: Save event detection via inspect().pending
...
## ADR-044-002: Authenticate resolves AuthManager not Guard
