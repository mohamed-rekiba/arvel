# ADR-134: Debugging and query-log parity
...
## ADR-134-01: Query logging hooks the engine, not the QueryBuilder
...
## ADR-134-02: `pretend` rolls back rather than truly skipping execution
...
## ADR-134-03: `to_raw_sql` / `get_bindings` / `explain` on the builder
