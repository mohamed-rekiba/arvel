# ADR-149: has-one-of-many (latest/oldest/of_many)
...
## ADR-149-01: Method style off `has_many` / `has_one`
...
## ADR-149-02: Descriptor style for eager loading (`HasOneOfMany`)
...
## ADR-149-03: Batched eager loading via a grouped subquery
...
## ADR-149-04: Query-builder complexity refactor
