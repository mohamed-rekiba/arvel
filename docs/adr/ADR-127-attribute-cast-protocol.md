# ADR-127: Attribute-level Custom Cast Protocol
...
## ADR-127-01: `CastsAttributes` ABC with get / set / serialize
...
## ADR-127-02: Resolve casts once at class definition, not per access
...
## ADR-127-03: Parameterized string specs; `decimal:N` first
