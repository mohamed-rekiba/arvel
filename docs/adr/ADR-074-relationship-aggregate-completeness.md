# ADR-074: relationship aggregate completeness
...
## ADR-074-01: `_aggregate_column` — one builder for every aggregate
...
## ADR-074-02: `with_aggregate` and the named wrappers
...
## ADR-074-03: aliasing and constraint closures
