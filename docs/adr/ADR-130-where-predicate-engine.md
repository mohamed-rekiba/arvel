# ADR-130: WHERE Predicate Engine and Clause Polish
...
## ADR-130-01: WHERE lives in a builder predicate, not on the `Select`
...
## ADR-130-02: `or_where` ORs onto the whole chain, with explicit grouping
...
## ADR-130-03: Clause polish bundle
