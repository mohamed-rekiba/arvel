# ADR-142: Distinct soft/hard-delete and replicate events
...
## ADR-142-01: `trashed` fires on soft delete, alongside `deleted`
...
## ADR-142-02: `force_deleting` / `force_deleted` wrap hard deletes
...
## ADR-142-03: `replicating` fires on the clone
...
## ADR-142-04: Bulk QueryBuilder deletes stay event-free

Status: Accepted

The story AC mentioned bulk-QB soft deletes firing `trashed`. We deliberately don't: per ADR-141 and
