# ADR-137: Declarative encrypted casts + app `Encrypter`
...
## ADR-137-01: A new app `Encrypter`, separate from column-level `EncryptedType`
...
## ADR-137-02: `Crypt` facade caches per `APP_KEY`
...
## ADR-137-03: Cast variants and the read/write/serialize contract
