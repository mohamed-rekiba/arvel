# ADR-072: polymorphic existence queries (where_has_morph / has_morph)
...
## ADR-072-01: `where_has_morph(relation, types, constraint=None)`
...
## ADR-072-02: `has_morph(relation, types, operator, count, constraint=None)`
...
## ADR-072-03: `where_morph_relation(relation, types, column, value)`
