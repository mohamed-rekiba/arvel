"""SocialAccount model — links a provider identity to a host User.
...
class SocialAccount(Model, Timestamps):
    ...
    __table_args__ = (
        UniqueConstraint("provider", "provider_id", name="social_accounts_provider_unique"),
    )
...
__all__ = ["EncryptedJson", "SocialAccount"]
