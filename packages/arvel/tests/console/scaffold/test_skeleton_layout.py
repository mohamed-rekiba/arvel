...
# — required files in skeleton root (template extensions OK)
@pytest.mark.parametrize(
    "candidate_names",
    [
...
# — storage placeholders + gitignore rule
@pytest.mark.parametrize(
    "path",
    [
        "storage/app/.gitkeep",
...
# — bootstrap/app.py with create_application()
