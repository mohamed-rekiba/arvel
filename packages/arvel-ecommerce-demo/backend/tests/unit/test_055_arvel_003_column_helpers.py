...
ARVEL_COLS = Path("/Users/Mohamed_Rekiba/temp/arvel/packages/arvel/src/arvel/database/columns.py")
ARVEL_MIXINS = Path("/Users/Mohamed_Rekiba/temp/arvel/packages/arvel/src/arvel/database/mixins.py")
ARVEL_PERM_MODELS = Path(
    "/Users/Mohamed_Rekiba/temp/arvel/packages/arvel-permission/src/arvel_permission/models.py"
)
ARVEL_PERM_TRAITS = Path(
    "/Users/Mohamed_Rekiba/temp/arvel/packages/arvel-permission/src/arvel_permission/traits.py"
)
DEMO = Path("/Users/Mohamed_Rekiba/temp/arvel/packages/arvel-ecommerce-demo/backend")
...
def test_arvel_permission_migration_has_level() -> None:
    ...
    migration = Path(
        "/Users/Mohamed_Rekiba/temp/arvel/packages/arvel-permission/src/arvel_permission"
