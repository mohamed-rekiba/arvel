"""AppServiceProvider — e-commerce demo application wiring."""
...
class AppServiceProvider(ServiceProvider):
    """Minimal provider for the e-commerce demo.
    ...
    def register(self) -> None:
        # Bind the demo's AuthController subclass so the DI container can
