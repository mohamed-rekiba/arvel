...
<template>
  <div class="flex gap-4 pb-2 scrollbar-hide sm:gap-6">
    ...
    >
      <div
        class="flex h-20 w-20 items-center justify-center rounded-full border-2 border-transparent bg-primary-50 shadow-sm transition duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:-translate-y-1 group-hover:border-brand group-hover:bg-primary-100 group-hover:shadow-md"
      >
        <span
