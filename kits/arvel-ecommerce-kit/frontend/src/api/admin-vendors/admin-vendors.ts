...
>(
  ...
  TContext
> => {
  return useMutation(getAdminVendorsStoreApiAdminVendorsPostMutationOptions(options), queryClient)
}
/**
...
>(
  ...
  return {
    queryKey,
    queryFn,
    enabled: computed(() => unref(vendorId) !== null && unref(vendorId) !== undefined),
    ...queryOptions,
  } as UseQueryOptions<
    Awaited<ReturnType<typeof adminVendorsShowApiAdminVendorsVendorIdGet>>,
    TError,
...
> => {
  return useMutation(
    getAdminVendorsUpdateApiAdminVendorsVendorIdPatchMutationOptions(options),
    queryClient,
  )
}
/**
...
export const adminVendorsDestroyApiAdminVendorsVendorIdDelete = (
  ...
  return request<unknown>(
    { url: `/api/admin/vendors/${vendorId}`, method: 'DELETE', signal },
    options,
  )
}
...
export const adminVendorsForceDestroyApiAdminVendorsVendorIdForceDelete = (
  ...
  return request<unknown>(
    { url: `/api/admin/vendors/${vendorId}/force`, method: 'DELETE', signal },
    options,
  )
}
...
export const adminVendorsPublishApiAdminVendorsVendorIdPublishPatch = (
  ...
  return request<AdminVendorWrapperOut>(
    { url: `/api/admin/vendors/${vendorId}/publish`, method: 'PATCH', signal },
    options,
  )
}
...
export const adminVendorsUnpublishApiAdminVendorsVendorIdUnpublishPatch = (
  ...
  return request<AdminVendorWrapperOut>(
    { url: `/api/admin/vendors/${vendorId}/unpublish`, method: 'PATCH', signal },
    options,
  )
}
