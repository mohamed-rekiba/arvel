...
export const useAuthLoginApiAuthLoginPost = <TError = HTTPValidationError, TContext = unknown>(
  ...
  TContext
> => {
  return useMutation(getAuthLoginApiAuthLoginPostMutationOptions(options), queryClient)
}
/**
...
>(
  ...
  TContext
> => {
  return useMutation(getAuthRegisterApiAuthRegisterPostMutationOptions(options), queryClient)
}
/**
 * @summary Auth.Me
 */
