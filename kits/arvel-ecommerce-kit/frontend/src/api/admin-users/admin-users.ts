...
>(
  ...
  return {
    queryKey,
    queryFn,
    enabled: computed(() => unref(userId) !== null && unref(userId) !== undefined),
    ...queryOptions,
  } as UseQueryOptions<
    Awaited<ReturnType<typeof adminUsersShowApiAdminUsersUserIdGet>>,
    TError,
...
export const adminUsersDestroyApiAdminUsersUserIdDelete = (
  ...
  return request<unknown>({ url: `/api/admin/users/${userId}`, method: 'DELETE', signal }, options)
}
...
> => {
  return useMutation(
    getAdminUsersDestroyApiAdminUsersUserIdDeleteMutationOptions(options),
    queryClient,
  )
}
/**
...
export const adminUsersForceDestroyApiAdminUsersUserIdForceDelete = (
  ...
  return request<unknown>(
    { url: `/api/admin/users/${userId}/force`, method: 'DELETE', signal },
    options,
  )
}
...
> => {
  return useMutation(
    getAdminUsersRestoreApiAdminUsersUserIdRestorePostMutationOptions(options),
    queryClient,
  )
}
/**
...
export const adminUsersSuspendApiAdminUsersUserIdSuspendPatch = (
  ...
  return request<AdminUserWrapperOut>(
    { url: `/api/admin/users/${userId}/suspend`, method: 'PATCH', signal },
    options,
  )
}
...
export const adminUsersUnsuspendApiAdminUsersUserIdUnsuspendPatch = (
  ...
  return request<AdminUserWrapperOut>(
    { url: `/api/admin/users/${userId}/unsuspend`, method: 'PATCH', signal },
    options,
  )
}
...
export const adminUsersRolesRevokeApiAdminUsersUserIdRolesDelete = (
  ...
  return request<AdminUserWrapperOut>(
    { url: `/api/admin/users/${userId}/roles`, method: 'DELETE', params: unref(params), signal },
    options,
  )
}
