...
export async function getAdminUser(
  ...
  return json<{ data: unknown }>(`/api/admin/users/${encodeURIComponent(String(userId))}`, {
    headers: { Authorization: `Bearer ${token}` },
  })
}
...
export async function assignAdminUserRole(
  ...
  return json<unknown>(`/api/admin/users/${encodeURIComponent(String(userId))}/roles`, {
    method: 'POST',
    headers: { Authorization: `Bearer ${token}` },
...
export async function grantAdminUserPermission(
  ...
  return json<unknown>(`/api/admin/users/${encodeURIComponent(String(userId))}/permissions`, {
    method: 'POST',
    headers: { Authorization: `Bearer ${token}` },
...
export async function runAdminUserAction(
  ...
  return json<unknown>(`/api/admin/users/${encodeURIComponent(String(userId))}/${action}`, {
    method: 'POST',
    headers: { Authorization: `Bearer ${token}` },
  })
}

export async function deleteAdminUser(token: string, userId: string | number): Promise<void> {
  return json<void>(`/api/admin/users/${encodeURIComponent(String(userId))}`, {
    method: 'DELETE',
    headers: { Authorization: `Bearer ${token}` },
  })
}

export async function forceDeleteAdminUser(token: string, userId: string | number): Promise<void> {
  return json<void>(`/api/admin/users/${encodeURIComponent(userId)}/force`, {
    method: 'DELETE',
    headers: { Authorization: `Bearer ${token}` },
  })
}
